...
/**
 * check_elf - Function that checks if is an ELF file.
...
/**
 * print_abi - FFunction that Prints the ABI version of an ELF header.
...
/**
 * main - outputs the ELF header at the start of an ELF file.
